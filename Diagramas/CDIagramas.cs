...
{
    public partial class CDIagramas : EditorGenerico
    {
        ...
        //Graphics Grafico;
        public CDIagramas(Controladores_DB.IDataBase db, System.Collections.Generic.List<Objetos.CSysObject> lista)//List<string> l)
        {
...
//            WindowState = FormWindowState.Maximized;
        ...
        private void CalculaTamaño()
        {
            ...
            if(Diseñador.Width <P.X + 100)
                Diseñador.Width = P.X + 100;
            if(Diseñador.Height <P.Y + 100)
